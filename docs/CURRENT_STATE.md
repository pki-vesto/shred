...
- Voeding: productbibliotheek met optionele barcode/labelmetadata, gerankte zoek, frequent meal quick-add, versioned meal templates met usage analytics, AI macro-lookup, voice-logging met confidence-pills.
