...
**Laatst bijgewerkt:** 2026-06-18 · **Release:** v1.12.0 + unreleased calorie cycling + missed-session advies + barcode/label velden + templateversies + template analytics + backlogreconciliatie favoriete swaps + API/frontend-testupdate · **SW cache:** `shred-v29` · **Backlog:** 61/200 + N1/N2 klaar (zie [PRODUCT_BACKLOG.md](PRODUCT_BACKLOG.md)).
...
- Voeding: productbibliotheek met optionele barcode/labelmetadata, gerankte zoek, versioned meal templates met usage analytics, AI macro-lookup, voice-logging met confidence-pills.
