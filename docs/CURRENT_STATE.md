...
**Laatst bijgewerkt:** 2026-06-18 · **Release:** v1.12.0 + unreleased calorie cycling + missed-session advies + barcode/label velden + templateversies + template analytics + frequent meal quick-add + macrokwaliteit + backlogreconciliatie favoriete swaps + API/frontend-testupdate · **SW cache:** `shred-v29` · **Backlog:** 63/200 + N1/N2 klaar (zie [PRODUCT_BACKLOG.md](PRODUCT_BACKLOG.md)).
...
- Voeding: productbibliotheek met macrokwaliteit, optionele barcode/labelmetadata, gerankte zoek, frequent meal quick-add, versioned meal templates met usage analytics, AI macro-lookup, voice-logging met confidence-pills.
