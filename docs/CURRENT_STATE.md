...
**Laatst bijgewerkt:** 2026-06-18 · **Release:** v1.12.0 + unreleased calorie cycling + missed-session advies + barcode/label velden + backlogreconciliatie favoriete swaps + API/frontend-testupdate · **SW cache:** `shred-v29` · **Backlog:** 59/200 + N1/N2 klaar (zie [PRODUCT_BACKLOG.md](PRODUCT_BACKLOG.md)).
...
- Voeding: productbibliotheek met optionele barcode/labelmetadata, gerankte zoek, templates, AI macro-lookup, voice-logging met confidence-pills.
