...
**Laatst bijgewerkt:** 2026-06-18 · **Release:** v1.12.0 + unreleased template analytics · **SW cache:** `shred-v29` · **Backlog:** 57/200 klaar (zie [PRODUCT_BACKLOG.md](PRODUCT_BACKLOG.md)).
...
- Voeding: productbibliotheek, gerankte zoek, templates met usage analytics, AI macro-lookup, voice-logging met confidence-pills.
