...
**Laatst bijgewerkt:** 2026-06-18 · **Release:** v1.12.0 + unreleased templateversies · **SW cache:** `shred-v29` · **Backlog:** 57/200 klaar (zie [PRODUCT_BACKLOG.md](PRODUCT_BACKLOG.md)).
...
- Voeding: productbibliotheek, gerankte zoek, versioned meal templates, AI macro-lookup, voice-logging met confidence-pills.
