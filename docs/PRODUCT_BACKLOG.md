...
**Stand: 62 klaar · 138 open** (laatst bijgewerkt 2026-06-18, t/m v1.12.0 + unreleased calorie cycling + missed-session advies + barcode/label velden + templateversies + template analytics + frequent meal quick-add + backlogreconciliatie favoriete swaps).
