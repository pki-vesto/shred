...
**Stand: 63 klaar · 137 open** (laatst bijgewerkt 2026-06-18, t/m v1.12.0 + unreleased calorie cycling + missed-session advies + barcode/label velden + templateversies + template analytics + frequent meal quick-add + macrokwaliteit + backlogreconciliatie favoriete swaps).
