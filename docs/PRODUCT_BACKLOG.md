...
**Stand: 58 klaar · 142 open** (laatst bijgewerkt 2026-06-18, t/m v1.12.0 + unreleased calorie cycling + missed-session advies + backlogreconciliatie favoriete swaps).
