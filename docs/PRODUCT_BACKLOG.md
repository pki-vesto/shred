...
**Stand: 61 klaar · 139 open** (laatst bijgewerkt 2026-06-18, t/m v1.12.0 + unreleased calorie cycling + missed-session advies + barcode/label velden + templateversies + template analytics + backlogreconciliatie favoriete swaps).
