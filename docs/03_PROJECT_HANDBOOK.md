...
- Voeding met productbibliotheek, macros per 100g, optionele barcode/labelmetadata, maaltijdcategorieën, frequent meal quick-add en versioned meal templates met usage analytics; gerankte productzoek (matchkwaliteit + gebruik + barcode/label).
