...
- Voeding met productbibliotheek, macros per 100g, optionele barcode/labelmetadata, maaltijdcategorieën en templates; gerankte productzoek (matchkwaliteit + gebruik + barcode/label).
